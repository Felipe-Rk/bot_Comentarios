...
def main():
    ...
    Tooltip(help_label,
        ...
        "Caso deseje alterar, selecione 'Todos' no comentários ou Recentes para os mais recentes"
         "                                                             \n"
    ...
    label_comentarios.grid(row=7, column=0, pady=10, padx=10, sticky='w')

    comentarios_var = tk.StringVar(value="Todos")
    ...
    select_comentarios.grid(row=7, column=1, pady=10, padx=10, sticky='w')
    ...
    btn_baixar_log.grid(row=10, column=0, columnspan=2, pady=10)

    label_rodape = ttk.Label(windows, text="Desenvolvedor: Felipe Roiko", font=("Times New Roman", 20, "italic"))
    label_rodape.grid(row=11, column=0, columnspan=2, pady=20)
    ...
    def update_fields(*args):
        ...
        if funcao == "Localizar":
            ...
            select_comentarios.config(state="disabled")
